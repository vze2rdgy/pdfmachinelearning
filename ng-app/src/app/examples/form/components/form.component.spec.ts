...
describe('FormComponent', () => {
  ...
  it('should submit when form is valid', async () => {
    component.input(
      component.getByLabelText('lynx.examples.form.placeholder1'),
      {
        target: {
    ...
    component.input(
      component.getByLabelText('lynx.examples.form.placeholder2'),
      {
        target: {
    ...
    component.input(
      component.getByLabelText('lynx.examples.form.placeholder3'),
      {
        target: {
          value: 'foo@bar.baz'
        }
    ...
    component.input(
      component.getByLabelText('lynx.examples.form.placeholder5'),
      {
        target: {
          value: '1991-12-31'
        }
    ...
    component.input(
      component.getByLabelText('lynx.examples.form.placeholder4'),
      {
        target: {
    ...
    component.click(component.getByLabelText('lynx.examples.form.text1'));
    component.click(component.getByText('lynx.examples.form.send'));
